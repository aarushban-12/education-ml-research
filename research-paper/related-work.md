...
More recent interpretable approaches continue to incorporate attention mechanisms, concept relationships, and educational domain knowledge to make knowledge tracing outputs more meaningful for educators. However, interpretability alone does not establish whether these educational interpretations are reliable for different types of learners. A model may identify the same prerequisite gap for two students while the reliability of that diagnosis differs depending on their underlying level of mathematical ability. Thus, evaluating the reliability of model-generated educational diagnoses across learner groups represents an important extension of existing work on interpretability in knowledge tracing.
